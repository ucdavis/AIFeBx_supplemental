...
-**Supplementary figure 12 a and b ** Weighted agreemenet and kappa per pathologist pair <figures/supplementary/S12a_weightedKappa_perPair.tif/>, <figures/supplementary/S12b_cohensKappa_perPair.tif/>,
...
output_file_tif <- paste0(supplementaryFigures_dir,"S12a_weightedKappa_perPair.tif")
...
# Save the plot as a tif file
output_file_tif <- paste0(supplementaryFigures_dir,"S12b_cohensKappa_perPair.tif")
tiff(output_file_tif, width = 7, height = 3.5, units = "in", res = 300)
print(plot)
dev.off()
...
-Parsed semiquantiative grades for lamina propria lymphocytes and plasma cells <output/wsiAssessment/laminaPropria_lymphocytesPlasmacells.rds>
#### Output
-**Supplemental Figure S11a-b** Heatmap of raw grades intraepithelial <figures/supplementary/S11a_rawIeGrades.tif/>, <figures/supplementary/S11b_rawLpGrades.tif/>
...
# Save the plot as a tif file
output_file_tif <- paste0(supplementaryFigures_dir,"S11a_rawIeGrades.tif")
...
# Save the plot as a tif file
output_file_tif <- paste0(supplementaryFigures_dir,"S11b_rawlpGrades.tif")
tiff(output_file_tif, width = 3.5, height = 7, units = "in", res = 300)
print(heatmap_grades)
dev.off()
